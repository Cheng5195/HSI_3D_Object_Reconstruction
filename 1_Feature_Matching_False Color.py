...
class FeatureMatcher:
    ...
    def match_single_channel(self, img1_channel, img2_channel, mask1=None, mask2=None):
        """Perform feature extraction and matching on single channel images"""
        # Detect keypoints and compute descriptors
        kp1, des1 = self.detect_and_compute(img1_channel, mask1)
        kp2, des2 = self.detect_and_compute(img2_channel, mask2)
