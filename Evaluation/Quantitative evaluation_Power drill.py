...
def main():
    ...
    truth_pcd = load_point_cloud('../Image Dataset/Evaluation/GT/Power drill.ply')
    print(f"Reference cloud: {len(truth_pcd.points)} points")
    
    # Generate list of point cloud files
    generated_files = [
        '../Image Dataset/Evaluation/Mean/Power drill/3_final_result_Mean.ply',
        '../Image Dataset/Evaluation/False Color/Power drill/3_final_result_False Color.ply',
        '../Image Dataset/Evaluation/All/Power drill/3_final_result_all.ply',
    ]
