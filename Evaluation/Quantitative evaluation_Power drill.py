...
def main():
    ...
    truth_pcd = load_point_cloud('GT/Power drill.ply')
    print(f"Reference cloud: {len(truth_pcd.points)} points")
    
    # Generate list of point cloud files
    generated_files = [
        'Mean/Power drill/3_final_result_Mean.ply',
        'False Color/Power drill/3_final_result_False Color.ply',
        'All/Power drill/3_final_result_all.ply',
    ]
