...
def load_edge_info(object_name, i, j):
    data = np.load(f'transformation/grayscale/{object_name}/transformation_{i}_{j}.npz')
    return {
        'source': i,
        'target': j,
...
def main():
    ...
    results_dir = f'results/grayscale/{object_name}'
    ...
    visualize_and_save_point_cloud(initial_combined, "Initial Alignment", 
                                 f"{results_dir}/1_initial_alignment_rgb.ply")
    ...
    visualize_and_save_point_cloud(
        ...
        f"{results_dir}/2_after_global_optimization_no_initial_icp.ply"
    )
    ...
    visualize_and_save_point_cloud(
        ...
        f"{results_dir}/3_final_result_gray.ply"
    )
